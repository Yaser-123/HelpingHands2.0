  ...
  return (
    <>
      ...
      <section className="p-5  dark:bg-gray-900">
        <div className=" min-h-screen dark:bg-[#101b2f] flex items-center justify-center">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="col">
                      <div className="card border-primary h-100">
                        <div className="card-body">
                          <p className="card-text text-lg sm:text-sm md:text-md">
              ...
              <div className="md:col-span-1 md:order-2 items-center justify-center md:block hidden">
                <div className="max-w-lg mx-auto">
                  <img
        ...
        <div className="home-features mt-5 bg-blue-200  dark:bg-[#10192F] p-3">
          <div className="featuresContainer">
            <div className="home-features1">
              <div className="home-container02">
                <h2
                  id="about"
                  className="text-3xl font-bold text-[#0EA5E9] mb-4 sm:text-lg md:text-3xl  "
                >
        ...
        <div className="home-banner mt-5">
          <div className="home-banner1 bannerContainer">
            <h2 className="text-3xl font-bold text-[#0EA5E9] mb-4 sm:text-lg md:text-3xl  ">
              Common questions
            </h2>
